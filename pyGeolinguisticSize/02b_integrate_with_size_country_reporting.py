...
for i in list_df.keys():
    df[i]=pd.io.pickle.read_pickle(list_df[i])
...
dfw[['Language',"Country", "Country Name", "Internet Population", "IPop"]].sort(["IPop","Internet Population"],ascending=False).to_csv("output_en_zh_IPop.csv", sep="\t", float_format='%4.2f')
...
dfw.to_csv("output_en_zh_PPPGDP.csv", sep="\t", float_format='%4.2f')
...
top20_lang_IPop[["Language Name","Internet Population", "Economy PPPGDP", "Population"]].sort(["Internet Population", "Economy PPPGDP"],ascending=False).to_csv("top20_lang_IPop.csv", sep=",", float_format='%4.2f')
top20_lang_IPop[["Language Name","Economy PPPGDP", "Population", "Internet Population"]].sort(["Economy PPPGDP", "Population"],ascending=False).to_csv("top20_lang_PPPGDP.csv", sep=",", float_format='%4.2f')
top20_lang_IPop[["Language Name","Population","Internet Population","Economy PPPGDP"]].sort(["Population","Internet Population"],ascending=False).to_csv("top20_lang_LP.csv", sep=",", float_format='%4.2f')
